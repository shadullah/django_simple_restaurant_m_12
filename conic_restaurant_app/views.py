...
def home(req):
    ...
    return render(req, 'conic_restaurant_app/home.html')

def about(req):
    return render(req, 'conic_restaurant_app/about.html')

def items(req):
    return render(req, 'conic_restaurant_app/items.html', {'data': data})